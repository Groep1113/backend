...
import nl.ooot.wms.networking.Dispatcher
...
object GraphQLDispatcher extends Dispatcher with CorsSupport {
  implicit val ec: ExecutionContextExecutor = WebServer.executionContext

  override def routes(): Route = path("graphql") {
    get {
